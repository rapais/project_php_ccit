...
<section class="show-products">
    ...
    <div class="box-container">
        ...
        if ($select_products !== false && mysqli_num_rows($select_products) > 0) {
            while ($fetch_products = mysqli_fetch_assoc($select_products)) {
                ...
                <div class="box">
                    ...
                    <a href="admin_products.php?update=<?php echo $fetch_products['products_id']; ?>" class="option-btn">update</a>
                    <a href="admin_products.php?delete=<?php echo $fetch_products['products_id']; ?>" class="delete-btn" onclick="return confirm('delete this product');">delete</a>
                </div>
                <?php
            }
        } 
...
<section class="edit-product-form">
    ...
    if (isset($_GET['update'])) {
        ...
        products_id = '$update_id'") or die('query failed');
...
if (isset($_POST['add_product'])) {
    ...
    $select_products_name = mysqli_query($conn, "SELECT name FROM `products` WHERE name = '$name'") or die('query failed');
...
if (isset($_GET['delete'])) {
    ...
    $delete_image_query = mysqli_query($conn, "SELECT image FROM `products` WHERE products_id = '$delete_id'") or die('query failed');
...
if(isset($_POST['update_product'])){
    ...
    mysqli_query($conn, "UPDATE `products` SET name = '$update_name', price = '$update_price' WHERE products_id = '$update_p_id'") or die('query failed');
    ...
    if(!empty($update_image)){
       if($update_image_size > 2000000){
        ...
        ';
          ...
          mysqli_query($conn, "UPDATE `products` SET image = '$update_image' WHERE products_id = '$update_p_id'") or die('query failed');
